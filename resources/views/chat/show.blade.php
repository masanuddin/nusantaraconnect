...
<div class="d-flex justify-content-center">
    <div style="width: 100%; max-width: 1200px;">
        ...
        @if (session()->has('chat_pop'))
            ...
            @endphp
            <div class="alert alert-success d-flex align-items-center mb-4 shadow-sm" style="background-color: #eaf6ef; border-color: #c3e6cb;">
                @if ($pop['thumbnail'])
        ...
        <form action="{{ route('chat.message.send', $chat->id) }}" method="POST" class="d-flex flex-column gap-2">
            ...
            <div class="d-flex justify-content-end">
                <button type="submit" class="btn" style="background-color: #f4e5dc; color: #5c3d25;">Kirim</button>
            </div>
        </form>
